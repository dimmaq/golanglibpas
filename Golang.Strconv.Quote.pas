...
(*
function appendQuotedWith(buf []byte, s string, quote byte, ASCIIonly, graphicOnly bool) []byte;
begin
...
function quoteWith(const s: UTF8String; const quote: UTF8Char;
  const ASCIIonly, graphicOnly: Boolean): UTF8String;
begin
	Result := s// appendQuotedWith(make([]byte, 0, 3*len(s)/2), s, quote, ASCIIonly, graphicOnly)
end;
...
function Quote(const s: UTF8String): UTF8String;
begin
	Result := quoteWith(s, '"', false, false);
end;
